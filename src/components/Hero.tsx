  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 lg:px-12 pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          Управление,
          <span className="block text-sage">которое работает</span>
        </h1>
        ...
        >
          Единое информационное поле для оперативного принятия решений. Визуализируем риски, контролируем показатели и снижаем объём отчётности.
        </p>
